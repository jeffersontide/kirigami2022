...
//     std::map<std::string, std::string> string_map; // 0
//     std::map<std::string, int> int_map; // 1
//     std::map<std::string, Real> Real_map; // 2
//
//     VariableContainer() {}
//
//     void push_back(std::string fieldname, std::string value) {
//         string_map[fieldname] = value;
//         keys[fieldname] = 0;
//     }
//
//     void push_back(std::string fieldname, int value) {
//         int_map[fieldname] = value;
//         keys[fieldname] = 1;
//     }
//
//     void push_back(std::string fieldname, Real value) {
//         Real_map[fieldname] = value;
//         keys[fieldname] = 2;
//     }
// };
...
public:
    ...
    ArgumentParser(const int argc, const char ** argv, bool writeOptions=true) : Parser(),parse_argc(argc), parse_argv(argv)
    {
